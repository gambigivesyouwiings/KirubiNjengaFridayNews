...
from wtforms import StringField, SubmitField, PasswordField, EmailField, FileField, TextAreaField
...
class SecondCommentForm(FlaskForm):
    # body = StringField("New Comment", validators=[DataRequired()])
